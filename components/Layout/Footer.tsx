...
const socialLinks = [
  { label: "Instagram", href: "https://www.instagram.com/dermotique_skin_laser_centre/?hl=en", icon: FaInstagram },
];
    ...
    <footer className="bg-[var(--warm-cream)] px-4 py-6 text-white md:px-7">
      <div className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[8px] border border-[#009EC8]/30 bg-zinc-950 shadow-[var(--shadow-soft)]">
        ...
        <div className="relative z-10 grid gap-10 px-5 py-8 md:px-8 lg:grid-cols-[1.45fr_0.8fr_0.8fr_1fr] lg:py-10">
          <div>
            <a href="#hero" className="relative block h-[94px] w-[150px] overflow-hidden rounded-[10px] " aria-label="Dermotique Skin and Laser Clinic home">
              <Image src="/assets/logo-2.png" alt="Dermotique Skin and Laser Clinic" fill sizes="150px" className="object-contain" />
            </a>
            <p className="mt-5 max-w-[380px] text-[13px] leading-[1.8] text-white/72">
              Dermatologist-led skin, hair, laser, and aesthetic care with individual treatment plans in Civil Lines, Gujranwala.
            </p>
          ...
          <div>
            ...
            <p className="mt-5 max-w-[280px] text-[13px] leading-[1.75] text-white/72">
              Have a skin, hair, or aesthetic concern? Start with a focused consultation at Dermotique.
            </p>
            <a
        ...
        <div className="relative z-10 flex flex-col gap-3 border-t border-white/14 bg-black/10 px-5 py-5 text-[12px] text-white/62 md:flex-row md:items-center md:justify-between md:px-8">
          <p>© 2026 Dermotique Skin &amp; Laser Clinic. All rights reserved.</p>
          <div className="flex flex-col gap-2 sm:flex-row sm:gap-5">
            <a href="tel:+923214089006" className="inline-flex items-center gap-2 hover:text-white"><Phone className="h-3.5 w-3.5" /> 0321 4089006</a>
            <p className="inline-flex items-center gap-2"><MapPin className="h-3.5 w-3.5" /> Hospital Road, Civil Lines, Gujranwala</p>
          </div>
        </div>
      </div>
    </footer>
