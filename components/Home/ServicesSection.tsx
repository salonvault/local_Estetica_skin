...
export default function ServicesSection() {
  ...
  return (
    <section ref={sectionRef} id="treatments" className="overflow-hidden bg-zinc-950 bg-gradient-to-b from-primary-1 to-primary-2 bg-cover bg-center py-16 text-white lg:py-20">
      <div className="container">
        <div className="mx-auto max-w-[980px] text-center">
          <p className="eyebrow text-white!">Estetica treatments</p>
        ...
        <div ref={trackRef} className="flex w-max will-change-transform">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(8,42,46,0.28),transparent_42%)] opacity-0 transition duration-500 group-hover:opacity-100" />
