  ...
  return (
    <div className="relative h-[104px] w-[104px] shrink-0 overflow-hidden rounded-[14px] bg-white/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.42)] md:h-[118px] md:w-[118px]">
      <Image
        ...
        alt="Clinical facial treatment at Estetica in Lahore"
        fill
        sizes="168px"
...
function ArrowBadge() {
  return (
    <span className="hero-cta-icon bg-white text-[#003E6D]">
        ...
        <div className="relative z-30 flex min-h-[calc(100vh-4px)] flex-col px-5 pb-6 pt-24 sm:px-7 md:px-12 md:pt-28 lg:grid lg:grid-rows-[auto_1fr_auto] lg:px-16 lg:pb-9 lg:pt-36">
          <div className="max-w-[690px]">
            <p className="hero-kicker">
              ...
              Dermatologist-led care in Lahore
            </p>
            ...
            <div className="mt-5 flex max-w-[410px] items-center gap-4 text-[#CFE0EE]/74">
            ...
            <p className="hero-copy mt-6">
              Dermatology, laser, facial, hair, and aesthetic treatments with personalised plans at Estetica in Gulshan-e-Ravi, Lahore.
            </p>

            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <a href="https://wa.me/923100111156" className="hero-cta bg-[#003E6D] text-white shadow-[0_18px_38px_rgba(0,62,109,0.32)] transition hover:bg-[#0F5C8C]">
                Book Appointment
                <ArrowBadge />
              </a>
          ...
          <div className="relative z-10 mt-[-46px] flex items-center gap-3 rounded-[14px] border border-white/16 bg-[#003E6D]/72 p-4 shadow-[0_22px_54px_rgba(0,62,109,0.32)] backdrop-blur-xl md:max-w-[520px] lg:hidden">
            <MiniImage />
            <div>
